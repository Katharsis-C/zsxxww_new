...
<tr class="rowColor">
<td class="colOne"><code><strong><a href="../../../org/libjpegturbo/turbojpeg/TJTransform.html#TJTransform(int,%20int,%20int,%20int,%20int,%20int,%20org.libjpegturbo.turbojpeg.TJCustomFilter)">TJTransform</a></strong>(int&nbsp;x,           int&nbsp;y,           int&nbsp;w,           int&nbsp;h,           int&nbsp;op,           int&nbsp;options,<a href="../../../org/libjpegturbo/turbojpeg/TJCustomFilter.html" title="interface in org.libjpegturbo.turbojpeg">TJCustomFilter</a>&nbsp;cf)</code>
<div class="block">Create a new lossless transform instance with the given parameters.</div>
</td>
</tr>
<tr class="altColor">
<td class="colOne"><code><strong><a href="../../../org/libjpegturbo/turbojpeg/TJTransform.html#TJTransform(java.awt.Rectangle,%20int,%20int,%20org.libjpegturbo.turbojpeg.TJCustomFilter)">TJTransform</a></strong>(java.awt.Rectangle&nbsp;r,           int&nbsp;op,           int&nbsp;options,<a href="../../../org/libjpegturbo/turbojpeg/TJCustomFilter.html" title="interface in org.libjpegturbo.turbojpeg">TJCustomFilter</a>&nbsp;cf)</code>
<div class="block">Create a new lossless transform instance with the given parameters.</div>
</td>
</tr>
</table>
...
<div class="block">Flip (mirror) image horizontally.  This transform is imperfect if there are any partial MCU blocks on the right edge.</div>
<dl><dt><span class="strong">See Also:</span></dt><dd><a href="../../../org/libjpegturbo/turbojpeg/TJTransform.html#OPT_PERFECT"><code>OPT_PERFECT</code></a>,<a href="../../../constant-values.html#org.libjpegturbo.turbojpeg.TJTransform.OP_HFLIP">Constant Field Values</a></dd></dl>
</li>
</ul>
<a name="OP_VFLIP">
</a>
...
<div class="block">Flip (mirror) image vertically.  This transform is imperfect if there are any partial MCU blocks on the bottom edge.</div>
<dl><dt><span class="strong">See Also:</span></dt><dd><a href="../../../org/libjpegturbo/turbojpeg/TJTransform.html#OPT_PERFECT"><code>OPT_PERFECT</code></a>,<a href="../../../constant-values.html#org.libjpegturbo.turbojpeg.TJTransform.OP_VFLIP">Constant Field Values</a></dd></dl>
</li>
</ul>
<a name="OP_TRANSPOSE">
</a>
...
<div class="block">Transpose image (flip/mirror along upper left to lower right axis).  This transform is always perfect.</div>
<dl><dt><span class="strong">See Also:</span></dt><dd><a href="../../../org/libjpegturbo/turbojpeg/TJTransform.html#OPT_PERFECT"><code>OPT_PERFECT</code></a>,<a href="../../../constant-values.html#org.libjpegturbo.turbojpeg.TJTransform.OP_TRANSPOSE">Constant Field Values</a></dd></dl>
</li>
</ul>
...
<div class="block">Transverse transpose image (flip/mirror along upper right to lower left axis).  This transform is imperfect if there are any partial MCU blocks in the image.</div>
<dl><dt><span class="strong">See Also:</span></dt><dd><a href="../../../org/libjpegturbo/turbojpeg/TJTransform.html#OPT_PERFECT"><code>OPT_PERFECT</code></a>,<a href="../../../constant-values.html#org.libjpegturbo.turbojpeg.TJTransform.OP_TRANSVERSE">Constant Field Values</a></dd></dl>
</li>
</ul>
<a name="OP_ROT90">
</a>
...
<div class="block">Rotate image clockwise by 90 degrees.  This transform is imperfect if there are any partial MCU blocks on the bottom edge.</div>
<dl><dt><span class="strong">See Also:</span></dt><dd><a href="../../../org/libjpegturbo/turbojpeg/TJTransform.html#OPT_PERFECT"><code>OPT_PERFECT</code></a>,<a href="../../../constant-values.html#org.libjpegturbo.turbojpeg.TJTransform.OP_ROT90">Constant Field Values</a></dd></dl>
</li>
</ul>
<a name="OP_ROT180">
</a>
...
<div class="block">Rotate image 180 degrees.  This transform is imperfect if there are any partial MCU blocks in the image.</div>
<dl><dt><span class="strong">See Also:</span></dt><dd><a href="../../../org/libjpegturbo/turbojpeg/TJTransform.html#OPT_PERFECT"><code>OPT_PERFECT</code></a>,<a href="../../../constant-values.html#org.libjpegturbo.turbojpeg.TJTransform.OP_ROT180">Constant Field Values</a></dd></dl>
</li>
</ul>
<a name="OP_ROT270">
</a>
...
<div class="block">Rotate image counter-clockwise by 90 degrees.  This transform is imperfect if there are any partial MCU blocks on the right edge.</div>
<dl><dt><span class="strong">See Also:</span></dt><dd><a href="../../../org/libjpegturbo/turbojpeg/TJTransform.html#OPT_PERFECT"><code>OPT_PERFECT</code></a>,<a href="../../../constant-values.html#org.libjpegturbo.turbojpeg.TJTransform.OP_ROT270">Constant Field Values</a></dd></dl>
</li>
</ul>
<a name="OPT_PERFECT">
</a>
...
<div class="block">This option will cause<a href="../../../org/libjpegturbo/turbojpeg/TJTransformer.html#transform(byte[][],%20org.libjpegturbo.turbojpeg.TJTransform[],%20int)"><code>TJTransformer.transform()</code></a>to throw an exception if the transform is not perfect.  Lossless transforms operate on MCU blocks, whose size depends on the level of chrominance subsampling used.  If the image's width or height is not evenly divisible by the MCU block size (see<a href="../../../org/libjpegturbo/turbojpeg/TJ.html#getMCUWidth(int)"><code>TJ.getMCUWidth(int)</code></a>
and<a href="../../../org/libjpegturbo/turbojpeg/TJ.html#getMCUHeight(int)"><code>TJ.getMCUHeight(int)</code></a>), then there will be partial MCU blocks on the right and/or bottom edges.   It is not possible to move these partial MCU blocks to the top or left of the image, so any transform that would require that is "imperfect."  If this option is not specified, then any partial MCU blocks that cannot be transformed will be left in place, which will create odd-looking strips on the right or bottom edge of the image.</div>
